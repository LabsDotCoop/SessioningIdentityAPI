 ...
 * @subpackage cake.cake.libs.cache
 */
class identityCacheModel extends identityCacheEngine
{
    /**
     * settings
    ...
    {
        $identityDB =& identityDatabaseFactory::getDatabaseConnection();

        parent::init($settings);
        $defaults = array('fields' => array('data' , 'expires'));
        $this->settings = array_merge($defaults, $this->settings);
        $this->fields = $this->settings['fields'];
        $this->model = new identityCacheModelHandler($identityDB);
        return true;
    }
 ...
 * @access public
 */
class identityCacheModelObject extends identityObject
{
    function identityCacheModelObject()
    {
        $this->__construct();
    }
 ...
 * @access public
 */
class identityCacheModelHandler extends identityPersistableObjectHandler
{
    const TABLE = 'cache_model';
    const CLASSNAME = 'identityCacheModelObject';
    const KEYNAME = 'key';
}
