...
class identityFileHandler
{
    ...
    {
        include_once dirname(__FILE__) . _DS_ . 'identityfile.php';
        $this->folder = identityFile::getHandler('folder', dirname($path), $create, $mode);
        if (!is_dir($path)) {
    ...
    /**
     * identityFileHandler::identityFileHandler()
     *
     * @param mixed $path
     * @param mixed $create
     * @param mixed $mode
     */
    function identityFileHandler($path, $create = false, $mode = 0755)
    {
