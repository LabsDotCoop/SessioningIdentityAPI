...
include_once dirname(__FILE__).'/qcp71.class.php';

if (!class_exists('Qcp71HashAPI')) {
	class Qcp71HashAPI extends identityHashAPI {
		...
		function __construct() {
			parent::setInfo(array('function'=>'getQcp71', 'author'=>'Simon Roberts', 'description'=>'XOOPS Hashinfo/Checksum'));
 ...
 * @param array $options
 */
if (!function_exists('getQcp71'))
{
	function getQcp71($data = NULL, $options = array())
	{
